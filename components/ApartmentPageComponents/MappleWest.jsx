...
const MapleWestComponent = ({ openContactModal }) => {
  ...
  return (
    <>
      {/* Desktop Version */}
      <div className="max-w-7xl mx-auto hidden md:flex flex-col lg:flex-row-reverse gap-8 lg:gap-12 items-center">
        {/* Image Section */}
      ...
      {/*Mobile Version  */}
      <div className="px-4 flex md:hidden flex-col lg:flex-row-reverse gap-8 lg:gap-12 items-center">
        ...
        <div>
          <div className="flex items-center gap-3 mb-3">
            {/* <span className="text-3xl">{apartment.emoji}</span> */}
            <h3 className="text-3xl md:text-4xl font-bold text-[#1b2638]">
              Elevating Your Lifestyle: Introducing {apartment.name} {apartment.emoji}
            </h3>
          </div>
          <div className="flex items-center gap-2 text-gray-600">
            <MapPin className="w-4 h-4" />
