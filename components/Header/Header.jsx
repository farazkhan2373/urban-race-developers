                        ...
                        <div className="flex justify-between items-center py-4">
                            ...
                            <nav className="hidden lg:flex items-center space-x-8">
                                ...
                                <div className="relative group">
                                    ...
                                    <div className="absolute top-full left-0 mt-2 bg-white shadow-lg rounded-lg py-2 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                                        <a href="/projects/current" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Current Projects</a>
                                        <a href="/projects/completed" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Completed Projects</a>
                                    </div>
                                </div>
                        ...
                        <div className="lg:hidden bg-white border-t">
                            <nav className="container mx-auto px-4 py-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    >
                                        <span>Projects</span>
                                        <ChevronDown size={16} className={`transform transition-transform ${isProjectsOpen ? 'rotate-180' : ''}`} />
                                    </button>
                                    {isProjectsOpen && (
                                        <div className="ml-4 mt-2 space-y-2">
                                            <a href="/projects/current" className="block text-gray-600 hover:text-[#1b2638]">Current Projects</a>
                                            <a href="/projects/completed" className="block text-gray-600 hover:text-[#1b2638]">Completed Projects</a>
                                        </div>
                                    )}
                                </div>
